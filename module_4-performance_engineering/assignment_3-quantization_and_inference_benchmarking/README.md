...
nvidia-smi
jupyter lab                                         # open hw_l6_quant_serving.ipynb
```
...
```bash
vllm serve <model-id> --quantization fp8 --max-model-len 4096   # use int8_per_channel_weight_only on an L40S
```
